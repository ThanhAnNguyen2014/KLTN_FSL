...
(function() {
    ...
    CKEDITOR.event || (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) { var d = CKEDITOR.event.prototype,
        ...
        return {
            ...
            on: function(b, d, g, k, l) {
                ...
                function u() { A.removeListener(b, d) } var e = a.call(this, b); if (0 > e.getListenerIndex(d)) { e = e.listeners;
                    g || (g = this);
                    isNaN(l) && (l = 10); var A = this;
                    m.fn = d;
                    m.priority = l; for (var r = e.length - 1; 0 <= r; r--)
                        if (e[r].priority <= l) return e.splice(r + 1, 0, m), { removeListener: u };
                    e.unshift(m) } return { removeListener: u } },
    ...
    (function() {
        ...
        CKEDITOR.tools = {
            ...
            extend: function(a) { var e = arguments.length,
                    b, c; "boolean" == typeof(b = arguments[e - 1]) ? e-- : "boolean" == typeof(b = arguments[e - 2]) && (c = arguments[e - 1], e -= 2); for (var l = 1; l < e; l++) { var d = arguments[l],
                        q; for (q in d)
                        if (!0 === b || null == a[q])
            ...
            normalizeCssText: function(a, e) { var b = [],
                    c, l = CKEDITOR.tools.parseCssText(a, !0, e); for (c in l) b.push(c + ":" + l[c]);
            ...
            getCookie: function(a) { a = a.toLowerCase(); for (var b = document.cookie.split(";"), c, l, d = 0; d < b.length; d++)
    ...
    (function(a) {
        ...
        a.removeCustomData = function(a) { var c = this.$["data-cke-expando"],
                c = c && d[c],
                f, g;
            c && (f = c[a], g = a in c, delete c[a]); return g ? f : null };
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.document.prototype, {
        ...
        getByAddress: function(a, d) {
            for (var b =
                    ...
                    for (var g = -1, k = 0; k < b.childNodes.length; k++) { var l = b.childNodes[k]; if (!0 !== d || 3 != l.nodeType || !l.previousSibling || 3 != l.previousSibling.nodeType)
                            if (g++, g == f) { b = l; break } } else b = b.childNodes[f] }
    ...
    (function() {
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            mergeSiblings: function() {
                function a(b, c, e) {
                    if (c && c.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        if (b.isIdentical(c)) { for (var l = e ? b.getLast() : b.getFirst(); d.length;) d.shift().move(b, !e);
                            c.moveChildren(b, !e);
                            c.remove();
            ...
            getDocumentPosition: function(a) {
                ...
                if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
                    ...
                    for (q = this, w = null; q && "body" != q.getName() &&
                        ...
                        q.equals(this) || (b += q.$.clientLeft || 0, c += q.$.clientTop || 0); for (; w && !w.equals(q);) b -= w.$.scrollLeft, c -= w.$.scrollTop, w = w.getParent();
                        w = q;
            ...
            scrollIntoParent: function(a, b, c) {
                ...
                function q(a, b) { var c = { x: 0, y: 0 }; if (!a.is(k ? "body" : "html")) { var e = a.$.getBoundingClientRect();
                        c.x = e.left;
                        c.y = e.top }
                    e = a.getWindow();
                    e.equals(b) || (e = q(CKEDITOR.dom.element.get(e.$.frameElement), b), c.x += e.x, c.y += e.y); return c }
    ...
    (function() {
        ...
        var e = CKEDITOR.dom.walker.empty(),
            A = CKEDITOR.dom.walker.validEmptyBlockContainers = CKEDITOR.tools.extend(function(a) { var b = {},
    ...
    (function() {
        ...
        function d(a, b, c, d, f) {
            function q(a, b, c, e) { var d = c ? a.getPrevious() : a.getNext(); if (e && l) return d;
                h || e ? b.append(a.clone(!0, f), c) : (a.remove(), v && b.append(a)); return d }

            function g() { var a, b, c, e = Math.min(N.length, B.length); for (a = 0; a < e; a++)
            ...
            if (h && n.type == CKEDITOR.NODE_TEXT && p.equals(n)) p = a.document.createText(p.substring(y, z)), c.append(p);
                ...
                for (var N = p.getParents(), B = n.getParents(), I = g(), F = N.length - 1, K = B.length - 1, G = c, L, Z, U, fa = -1, Q = I; Q <= F; Q++) {
                    Z =
                        N[Q];
                    U = Z.getNext();
                    for (Q != F || Z.equals(B[Q]) && F < K ? b && (L = G.append(Z.clone(0, f))) : J ? q(Z, G, !1, C) : m && G.append(a.document.createText(Z.substring(y))); U;) { if (U.equals(B[Q])) { fa = Q; break }
                        U = q(U, G) }
                    G = L
                }
                G = c;
                for (Q = I; Q <= K; Q++)
                    ...
                    else { Q != K || c.equals(N[Q]) && K < F ? b && (L = G.append(c.clone(0, f))) : E ? q(c, G, !1, u) : O && G.append(a.document.createText(c.substring(0, z))); if (Q > fa)
                            for (; U;) U = q(U, G, !0);
                        G = L }
                h || k()
            }
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            createBookmark2: function() {
                function a(b) {
                    ...
                    f && (e = e.getChild(d -
                        1), d = e.getLength());
                    if (e.type == CKEDITOR.NODE_ELEMENT && 0 < d) { a: { for (f = e; d--;)
                                if (g = f.getChild(d).getIndex(!0), 0 <= g) { d = g; break a }
                            d = -1 }
                        d += 1 }
                    if (e.type == CKEDITOR.NODE_TEXT) { f = e; for (g = 0;
            ...
            trim: function(a, b) {
                var c = this.startContainer,
                    ...
                    f = this.collapsed;
                if ((!a ||
                        f) && c && c.type == CKEDITOR.NODE_TEXT) { if (d)
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        var q = function(a, b) {
                            ...
                            for (c.guard = function(a) { return !(a.type == CKEDITOR.NODE_ELEMENT && a.isBlockBoundary()) }; e =
                                c.next();) { if (e.type != CKEDITOR.NODE_TEXT) return !1;
                                J = e != a ? e.getText() : e.substring(b); if (d.test(J)) return !1 }
                            return !0
                        };
                        ...
                        for (h = c(h); h || p;) {
                            ...
                            for (; p;)
                                if (z = !1, p.type == CKEDITOR.NODE_COMMENT) p = p.getPrevious();
                                    ...
                                    if (p) { z = p.getPrevious(); if (!h && !z) { h = p;
                                            p = null; break }
                                        p = z } else h = null
                                }
                            h && (h = c(h.getParent()))
                        ...
                        for (; h ||
                            p;) {
                            if (h && !p) {!n && h.equals(g) && (n = !0); if (f ? h.isBlockBoundary() : !k.contains(h)) break;
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) { h = this.clone();
                            h = new CKEDITOR.dom.walker(h); var F = CKEDITOR.dom.walker.whitespaces(),
                                K = CKEDITOR.dom.walker.bookmark();
                            h.evaluator = function(a) { return !F(a) && !K(a) }; if ((h = h.previous()) && h.type == CKEDITOR.NODE_ELEMENT && h.is("br")) break }
                        h = this.clone();
                        h.collapse();
    ...
    (function() {
        ...
        function b(a, c, f, g) {
            a: { null == g && (g = d(f)); for (var k; k = g.shift();)
                ...
                for (this._.nextNode = null; w;) {
                    ...
                    if (v) w.type == CKEDITOR.NODE_TEXT && f.test(w.getText()) && (v = 0);
                        ...
                        if (CKEDITOR.dtd.$block[p] && "false" == w.getAttribute("contenteditable")) { d = w;
                            b(this, a, d); break } else if (w.isBlockBoundary(this.forceBrBreak && !t && { br: 1 })) { if ("br" == p) v = 1;
                            else if (!k && !w.getChildCount() && "hr" != p) { d = w;
                                r = w.equals(q); break }
                            k && (k.setEndAt(w, CKEDITOR.POSITION_BEFORE_START), "br" != p && (this._.nextNode = w));
                            H = 1 } else { if (w.getFirst()) { k || (k = this.range.clone(), k.setStartAt(w, CKEDITOR.POSITION_BEFORE_START));
                                w = w.getFirst(); continue }
                            v = 1 }
                    }
                    v && !k && (k = this.range.clone(), k.setStartAt(w, CKEDITOR.POSITION_BEFORE_START));
                    r = (!H || v) && w.equals(q);
                    if (k && !H)
                        for (; !w.getNext(l) && !r;) { p = w.getParent(); if (p.isBlockBoundary(this.forceBrBreak && !t && { br: 1 })) { H = 1;
                                v = 0;
                                r || p.equals(q);
    ...
    (function() {
        function a(a, b, c, d, f) {
            ...
            for (d = a.length; c < d; ++c) {
                ...
                for (F in N) { e = N[F];
                    g = n[e];
                    v = [];
                    y = void 0; for (y in g) - 1 < y.indexOf("*") ? v.push(new RegExp("^" + y.replace(/\*/g, ".*") + "$")) : v.push(y);
                    g = v;
                    g.length && (n[e] = g, q = !1) }
                n.nothingRequired = q;
        ...
        function k(a, b) { if (!a) return !1; if (!0 === a) return a; if ("string" == typeof a) return a = Y(a), "*" == a ? !0 : CKEDITOR.tools.convertArrayToObject(a.split(b)); if (CKEDITOR.tools.isArray(a)) return a.length ? CKEDITOR.tools.convertArrayToObject(a) : !1; var c = {},
                d = 0,
        ...
        function e(a) { var b, c, d, h, p = {},
                f = 1; for (a = Y(a); b = a.match(B);)(c = b[2]) ? (d = A(c, "styles"), h = A(c, "attrs"), c = A(c, "classes")) : d = h = c = null, p["$" + f++] = { elements: b[1], classes: c, styles: d, attributes: h }, a = a.slice(b[0].length); return p }
        ...
        function x(a, b, h, f) {
            ...
            if (f.doCallbacks && a.elementCallbacks) { a: { e = a.elementCallbacks; for (var g = 0, v = e.length, y; g < v; ++g)
                        if (y = e[g](b)) { e = y; break a }
                    e = void 0 } if (e) return e }
            if (f.doTransform && (e = a._.transformations[b.name])) { r(b); for (g = 0; g < e.length; ++g) p(a, b, e[g]);
                q(b) }
            if (f.doFilter) {
                a: {
                    ...
                    if (a || e) { r(b); if (g)
                        ...
                        if (v)
                            for (B = 0, z = v.length; B < z; ++B) c(v[B], b, k); if (a)
                            for (B = 0, z = a.length; B < z; ++B) d(a[B], b, k, y); if (e)
                ...
                if (!a.allStyles || a.hadInvalidStyle) { for (G in J) a.allStyles || E[G] ? C.push(G + ":" + J[G]) : B = !0;
                    C.length && (g.style = C.sort().join("; ")) } else l && (g.style = l);
                if (!a.allClasses ||
                    a.hadInvalidClass) { for (G = 0; G < v.length; ++G)(a.allClasses || e[v[G]]) && k.push(v[G]);
        ...
        CKEDITOR.filter.prototype = {
            ...
            disallow: function(b) { if (!g(this, b, !0)) return !1; "string" == typeof b && (b = e(b));
                a(this, b, null, this.disallowedContent, this._.disallowedRules); return !0 },
            addContentForms: function(a) { if (!this.disabled && a) { var b, c, d = [],
                        h; for (b = 0; b < a.length && !h; ++b) c = a[b], ("string" == typeof c || c instanceof CKEDITOR.style) && this.check(c) && (h = c); if (h) { for (b = 0; b < a.length; ++b) d.push(y(a[b], h));
            ...
            load: function(b, c, f, g) {
                ...
                if (0 === l) e(!0);
                    ...
                    var A = function(a, b) {
                        ...
                        r = function(b, c) { a[b] = 1; var f = d[b];
    ...
    CKEDITOR.resourceManager.prototype = {
        ...
        load: function(a, d, b) {
            ...
            CKEDITOR.scriptLoader.load(g, function(a, f) { if (f.length) throw Error('[CKEDITOR.resourceManager.load] Resource name "' + k[f[0]].join(",") + '" was not found at "' + f[0] + '".'); for (var e = 0; e < a.length; e++)
                    for (var g = k[a[e]], q = 0; q < g.length; q++) { var w = g[q];
                        l[w] = this.get(w);
                        c[w] = 1 }
                d.call(b, l) }, this)
        }
            ...
            var g = {},
                k = function(b) {
                    a.call(this, b, function(a) {
                        ...
                        var b = [],
                            e;
                        for (e in a) { var l = a[e],
                                r = l && l.requires; if (!d[e]) { if (l.icons)
                        ...
                        if (b.length) k.call(this,
                            b);
                        else { for (e in g) l = g[e], l.onLoad && !l.onLoad._called && (!1 === l.onLoad() && delete g[e], l.onLoad._called = 1);
                            c && c.call(f || window, g) }
                    }, this)
                };
            k.call(this, b)
    ...
    (function() {
                ...
                CKEDITOR.scriptLoader.load(f, function() {
                    for (var c = ["beforeInit", "init", "afterInit"], f = 0; f < c.length; f++)
                        for (var p =
                            ...
                            0 === f && h[p] && n.lang && n.langEntries && (a.lang[n.name] = n.langEntries[h[p]]); if (n[c[f]]) n[c[f]](a) }
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            ...
            getSelectedHtml: function(a) {
                ...
                for (var d = new CKEDITOR.dom.documentFragment, f, h, p, n = 0; n < c.length; n++) { var e = c[n],
                        g = e.startContainer;
        ...
        CKEDITOR.htmlParser.prototype = {
            ...
            parse: function(b) {
                for (var c, f, g = 0, k; c = this._.htmlPartsRegex.exec(b);) {
                    ...
                    if (k) k.push(c[0]);
                    else if (f = c[3]) { if (f = f.toLowerCase(), !/="/.test(f)) { var l = {},
                                m, u = c[4];
                            c = !!c[5]; if (u)
                                for (; m = a.exec(u);) { var e = m[1].toLowerCase();
                                    m = m[2] || m[3] || m[4] || "";
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function(g, k, l) {
                function m(a) { var b; if (0 < w.length)
                        for (var c = 0; c < w.length; c++) { var d = w[c],
                                h = d.name,
                                f = CKEDITOR.dtd[h],
                ...
                function A(b, c, d) { c = c || t || q; var f = t;
                ...
                D.onText = function(a) { if (!(t._.hasInlineStarted && !H.length || h || v) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) return; var b = t.name,
                        e = b ? CKEDITOR.dtd[b] || (t._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c; if (!v && !e["#"] && b in d) D.onTagOpen(f[b] || ""), D.onText(a);
                    else { u();
                        m();
                        h || v || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
                        a = new CKEDITOR.htmlParser.text(a); if (r(t, a)) this.onTagOpen(l, {}, 0, 1);
                        t.add(a) } };
                D.onCDATA =
    ...
    (function() {
        ...
        a.prototype = {
            ...
            addMany: function(a,
                c, d) { for (var g = [this.findIndex(c), 0], k = 0, l = a.length; k < l; k++) g.push({ value: a[k], priority: c, options: d });
            ...
            exec: function(a, c) {
                ...
                for (A = 0; A < l; A++)
                    if (d && (m = c.type, u = c.name), e = k[A], !(a.nonEditable && !e.options.applyToAll ||
                            a.nestedEditable && e.options.excludeNestedEditable)) { e = e.value.apply(null, g); if (!1 === e || d && e && (e.name != u || e.type != m)) return e;
                        null != e && (g[0] = c = e) }
                return c
            },
    ...
    (function() {
        ...
        var w = /(?:&nbsp;|\xa0)$/,
            ...
            y = { elements: { embed: function(a) { var b = a.parent; if (b && "object" == b.name) { var c = b.attributes.width,
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            ...
            filter: function(a, b) {
                ...
                for (;;) { k = d.name; if (!(l = a.onElementName(b, k))) return this.remove(), !1;
                    d.name = l; if (!(d = a.onElement(b, d))) return this.remove(), !1; if (d !== this) return this.replaceWith(d), !1; if (d.name == k) break; if (d.type != CKEDITOR.NODE_ELEMENT) return this.replaceWith(d), !1; if (!d.name) return this.replaceWithChildren(), !1 }
                k = d.attributes;
                var m, u;
                for (m in k) {
                    for (l = k[m];;)
            ...
            writeHtml: function(a, b) { b && this.filter(b); var g = this.name,
                    ...
                    l = this.attributes,
                    m, u;
                a.openTag(g, l); for (m in l) k.push([m, l[m]]);
                a.sortAttributes && k.sort(d);
                m = 0; for (u = k.length; m < u; m++) l = k[m], a.attribute(l[0], l[1]);
    ...
    (function() {
        ...
        function u(a, b, c) { var d = a.getCommonAncestor(b); for (b = a = c ? b : a;
            ...
            proto: {
                ...
                fixInitialSelection: function() {
                    function a() { var b = c.getDocument().$,
                        ...
                        a: if (d.anchorNode && d.anchorNode == c.$) h = !0;
                            else { if (CKEDITOR.env.webkit && (h = c.getDocument().getActive()) && h.equals(c) && !d.anchorNode) { h = !0; break a }
                                h = void 0 }
                ...
                setup: function() {
                    ...
                    if (!this.is("textarea")) {
                        ...
                        CKEDITOR.env.gecko && this.attachListener(this, "mouseup", function(b) { if (2 == b.data.$.button && (b = b.data.getTarget(), !b.getOuterHtml().replace(D, ""))) { var c = a.createRange();
                        ...
                        CKEDITOR.env.webkit && this.attachListener(a, "key", function(b) {
                            ...
                            if (b in l) {
                                ...
                                if (d.collapsed) a: {
                                    var h = b.block;
                                    if (h && d[c ? "checkStartOfBlock" : "checkEndOfBlock"]() && d.moveToClosestEditablePosition(h, !c) && d.collapsed) { if (d.startContainer.type == CKEDITOR.NODE_ELEMENT) { var f = d.startContainer.getChild(d.startOffset - (c ? 1 : 0)); if (f && f.type == CKEDITOR.NODE_ELEMENT && f.is("hr")) { a.fire("saveSnapshot");
                                                f.remove();
                                                b = !0; break a } }
                                        d = d.startPath().block; if (!d || d && d.contains(h)) b = void 0;
                                        else { a.fire("saveSnapshot"); var e;
        ...
        CKEDITOR.on("instanceLoaded", function(b) {
            ...
            c.on("selectionChange",
                function(b) { if (!c.readOnly) { var d = c.getSelection();
            ...
            b.on("mode", function() {
                ...
                if (a && a.isInline()) {
                    ...
                    if (d && (c = this.ui.space(this.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ? "top" :
                            "contents"))) { var f = CKEDITOR.tools.getNextId(),
        ...
        q = function() {
            ...
            function d(b, c) { var f = [],
                    e = b.getChildren(),
                    h = e.count(),
                    n, g = 0,
                    k = E[c],
                    y = !b.is(E.$inline) || b.is("br"); for (y && f.push(" "); g < h; g++) n = e.getItem(g), a(n) && !n.is(k) ? f = f.concat(d(n, c)) : f.push(n);
                y && f.push(" "); return f }
            ...
            function g(b, c, d, f) { var e = b.clone(),
                    h, n;
                ...
                if (!I.checkReadOnly()) {
                    ...
                    if (L = B) {
                        ...
                        if ("text" == m.type && m.inlineStylesRoot) { r = m.inlineStylesPeak;
                            C = r.getDocument().createText("{cke-peak}"); for (I = m.inlineStylesRoot.getParent(); !r.equals(I);) C = C.appendTo(r.clone()), r = r.getParent();
                            B = C.getOuterHtml().split("{cke-peak}").join(B) }
                        r = m.blockLimit.getName();
                        if (/^\s+|\s+$/.test(B) && "span" in CKEDITOR.dtd[r]) { var A = '\x3cspan data-cke-marker\x3d"1"\x3e\x26nbsp;\x3c/span\x3e';
                            B = A + B + A }
                    ...
                    if (L) {
                        ...
                        for (J(C, x); I < C.length; I++) {
                            ...
                            if (t) B = 0 < I;
                                ...
                                if (F && G.isElement) { t = x.startContainer; for (R = null; t && !E[t.getName()][G.name];) { if (t.equals(r)) { t = null; break }
                                        R = t;
                                        t = t.getParent() } if (t) R && (W = x.splitElement(R), m.zombies.push(W), m.zombies.push(R));
                                    else { R = r.getName();
                                        X = !I;
                                        t = I == C.length - 1;
                                        R = d(G.node, R); for (var T = [], aa = R.length, ba = 0, da = void 0, ea = 0, ga = -1; ba < aa; ba++) da = R[ba], " " == da ? (ea || X && !ba || (T.push(new CKEDITOR.dom.text(" ")), ga = T.length), ea = 1) : (T.push(da), ea = 0);
                                        t && ga == T.length && T.pop();
                                        X = T } }
                                if (X) {
                    ...
                    D.moveToBookmark(X);
                    if (!m.dontMoveCaret) { for (M = f(D); M && a(M) && !M.is(E.$empty);) { if (M.isBlockBoundary()) D.moveToPosition(M, CKEDITOR.POSITION_BEFORE_END);
                            else { if (e(M) && M.getHtml().match(/(\s|&nbsp;)$/g)) { S = null; break }
                                S = D.clone();
        ...
        H = {
            ...
            tree: {
                rebuild: function(a, b) {
                    ...
                    if (e.blockLimit.is({ tr: 1, table: 1 })) { var k = e.contains("table").getParent();
                        g = function(a) { return !a.equals(k) } } else if (e.block && e.block.is(CKEDITOR.dtd.$listItem) && (f = f.contains(CKEDITOR.dtd.$list), c = c.contains(CKEDITOR.dtd.$list), !f.equals(c))) { var l = e.contains(CKEDITOR.dtd.$list).getParent();
                ...
                table: function() {
                    function a(c) {
                        ...
                        h.guard = function(a, h) {
                            if (a.type == CKEDITOR.NODE_ELEMENT) { var k = "visited_" + (h ? "out" : "in"); if (a.getCustomData(k)) return;
                            ...
                            if (h && g && a.equals(g)) f = c.clone(), f.setEndAt(g, CKEDITOR.POSITION_BEFORE_END), e.push(f);
                                ...
                                e.push(f);
                            else { if (k = !h) k = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!g || b(a, g)) && (!n || b(a, n));
                    ...
                    return {
                        ...
                        deleteRanges: function(a) { for (var b; b = a.tableContentsRanges.pop();) b.extractContents(), r(b.startContainer) && b.startContainer.appendBogus();
    ...
    (function() {
        ...
        function g(a) { k(a, !1); var b = a.getDocument().createText(x);
                ...
                if (!c.collapsed) {
                    ...
                    d.evaluator = function(d) {
                        if (d.type == CKEDITOR.NODE_ELEMENT &&
                            ...
                            d.getPosition(k.endContainer) & CKEDITOR.POSITION_CONTAINS || (e.setStartAfter(d), e.collapsed || a.splice(b + 1, 0, e)); return !0 }
                        return !1
                    };
                    d.next()
                }
        ...
        CKEDITOR.on("instanceCreated", function(b) {
            ...
            e.on("contentDom", function() {
                    ...
                    if ("BackCompat" != f.$.compatMode) {
                        if (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) {
                            ...
                            l.on("mousedown", function(a) {
                                function b(a) { a = a.data.$; if (F) { var c = p.$.createTextRange(); try { c.moveToPoint(a.clientX, a.clientY) } catch (d) {}
                                ...
                                a = a.data;
                                if (a.getTarget().is("html") && a.$.y < l.$.clientHeight && a.$.x < l.$.clientWidth) { F = p.$.createTextRange(); try { F.moveToPoint(a.$.clientX, a.$.clientY) } catch (d) {}
                                    K = F.duplicate();
                                    l.on("mousemove", b);
                                    h.on("mouseup", c);
                                    l.on("mouseup", c) }
                ...
                g.attachListener(g, CKEDITOR.env.webkit ? "DOMFocusIn" : "focus", function() { e.forceNextSelectionCheck();
                    e.selectionChange(1) });
                if (m && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) { var G;
        ...
        CKEDITOR.dom.selection.prototype = {
            ...
            getType: A ? function() {
                ...
                return a.type = b
                    ...
                    c = this.getNative(); if (!c || !c.rangeCount) b = CKEDITOR.SELECTION_NONE;
                        ...
                        d = c.startContainer;
                    d == c.endContainer && 1 == d.nodeType && 1 == c.endOffset - c.startOffset && v[d.childNodes[c.startOffset].nodeName.toLowerCase()] && (b = CKEDITOR.SELECTION_ELEMENT) } return a.type = b },
            getRanges: function() {
                var a = A ? function() {
                ...
                return function(b) { var c = this._.cache,
                        d = c.ranges;
                    d || (c.ranges = d = new CKEDITOR.dom.rangeList(a.call(this))); return b ? e(new CKEDITOR.dom.rangeList(d.slice())) : d }
            }(),
            ...
            getSelectedElement: function() { var a = this._.cache; if (void 0 !== a.selectedElement) return a.selectedElement; var b = this,
                    c = CKEDITOR.tools.tryThese(function() { return b.getNative().createRange().item(0) }, function() { for (var a = b.getRanges()[0].clone(), c, d, e = 2; e && !((c = a.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && v[c.getName()] && (d = c)); e--) a.shrink(CKEDITOR.SHRINK_ELEMENT); return d && d.$ }); return a.selectedElement = c ? new CKEDITOR.dom.element(c) : null },
                        ...
                        if (l) this.fake(l);
                            ...
                            if (A) {
                                ...
                                for (t = 0; t < a.length; t++) {
                                    ...
                                    try { r.setEnd(l.endContainer.$, l.endOffset) } catch (B) { if (0 <= B.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) l.collapse(1), r.setEnd(l.endContainer.$, l.endOffset);
                                        else throw B; }
                                    e.addRange(r)
                                }
                            }
            ...
            removeAllRanges: function() { if (this.getType() != CKEDITOR.SELECTION_NONE) { var a = this.getNative(); try { a && a[A ? "empty" : "removeAllRanges"]() } catch (b) {}
                    this.reset() } }
        }
    })();
    "use strict";
    ...
    (function() {
                ...
                for (r.getPosition(u) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
                    ...
                    if (r.equals(u)) r = null, l = !0;
                        ...
                        if (v && m && CKEDITOR.dtd.$block[x])
                            for (var w = r, y = f(w), z = void 0, C = y.length, E = 0, w = C && new CKEDITOR.dom.range(w.getDocument()); E < C; ++E) { var z = y[E],
                                    J = CKEDITOR.filter.instances[z.data("cke-filter")]; if (J ? J.check(this) : 1) w.selectNodeContents(z), b.call(this, w) }
                        ...
                        if (y)
                            if (z = r.getParent(), y = h, C = g, E = k, !z || !(z.getDtd() || CKEDITOR.dtd.span)[C] && !E || y.parentRule && !y.parentRule(z)) l = !0;
                                ...
                                if (t ||
                                    x && CKEDITOR.dtd.$removeEmpty[x] && (r.getPosition(u) | O) != O || (t = c.clone(), t.setStartBefore(r)), x = r.type, x == CKEDITOR.NODE_TEXT || v || x == CKEDITOR.NODE_ELEMENT && !r.getChildCount()) { for (var x = r, P;
        ...
        function c(a) {
            ...
            if (a.collapsed) {
                ...
                if (f) {
                    ...
                    n = this;
                b(); for (e = d; !e.equals(m);) f = e.getNextSourceNode(), e.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(e) && (e.getName() == this.element ? x.call(this, e) : q(e, h(this)[e.getName()]), f.type == CKEDITOR.NODE_ELEMENT && f.contains(d) && (b(), f = d.getNext())), e = f }
            a.moveToBookmark(c);
        ...
        function l(a) { var b = a.createBookmark(!0),
            ...
            this._.enterMode && (c.enlargeBr = this._.enterMode != CKEDITOR.ENTER_BR); for (var d, e = a.document, f; d = c.getNextParagraph();) !d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (f = H(this, e, d), u(d, f));
            a.moveToBookmark(b) }
        ...
        function D(a) { for (var b = h(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e;) d = c.getItem(e), d.isReadOnly() || x.call(this, d, !0); for (var f in b)
                if (f != this.element)
        ...
        function w(a, b) {
            if (!a.hasAttributes() || b)
                if (CKEDITOR.dtd.$block[a.getName()]) { var c = a.getPrevious(P),
        ...
        CKEDITOR.style.prototype = {
            apply: function(a) { if (a instanceof CKEDITOR.dom.document) return y.call(this, a.getSelection()); if (this.checkApplicable(a.elementPath(), a)) { var b = this._.enterMode;
        ...
        CKEDITOR.dom.elementPath = function(b, f) {
            ...
            do
                if (m.type == CKEDITOR.NODE_ELEMENT) {
                    ...
                    if (m.equals(f)) break;
                    if (!k && (u = m.getName(),
                            "true" == m.getAttribute("contenteditable") ? k = m : !g && d[u] && (g = m), a[u])) { if (u = !g && "div" == u) { a: { u = m.getChildren(); for (var e = 0, A = u.count(); e < A; e++) { var r = u.getItem(e); if (r.type == CKEDITOR.NODE_ELEMENT && CKEDITOR.dtd.$block[r.getName()]) { u = !0; break a } }
                                u = !1 }
                            u = !u }
                        u ? g = m : k = m }
                }
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
        ...
        split: function(a) { var d = this.$.parentNode,
            ...
            d.childNodes.length == b && (a >= c ? (g = f.createText(""), g.insertAfter(this)) : (a = f.createText(""), a.insertAfter(g), a.remove())); return g },
    ...
    */
        ...
        function w(a) {
            ...
            return function(c, h) {
                if (!this.isReadOnly()) {
                    var e;
                    if (e = c == (f || d ?
                            "dir" : "direction") || "style" == c && (d || b.test(h))) { a: { e = this; for (var g = e.getDocument().getBody().getParent(); e;) { if (e.equals(g)) { e = !1; break a }
                                e = e.getParent() }
                            e = !0 }
                        e = !e }
    ...
    (function() {
        ...
        function x(b, a, c) { a = CKEDITOR.htmlParser.fragment.fromHtml(a); var d = new CKEDITOR.htmlParser.basicWriter;
            c.applyTo(a, !0, !1, b.activeEnterMode);
            a.writeHtml(d); return d.getHtml() }
        ...
        function F(b) {
            ...
            b.on("contentDom", function() {
                ...
                f.attachListener(b, "dragstart", function() { var d = a.dragRange = b.getSelection().getRanges()[0];
                ...
                f.attachListener(h, "drop", function(d) {
                    if (!d.data.$.defaultPrevented) {
                        ...
                        if (!c.isReadOnly() || c.type == CKEDITOR.NODE_ELEMENT &&
                            c.is("html")) { var c = a.getRangeAtDropPosition(d, b),
                                f = a.dragRange;
                            c && e(d, f, c) }
                    }
                }, null, null, 9999);
                f.attachListener(b, "drop", a.initDragDataTransfer, a, null, 1);
                f.attachListener(b, "drop", function(e) { if (e = e.data) { var f = e.dropRange,
                            g = e.dragRange,
                            h = e.dataTransfer;
        ...
        CKEDITOR.plugins.add("clipboard", {
            ...
            init: function(b) {
                ...
                b.on("paste", function(a) {
                    ...
                    if (b.match(/^<[^<]+cke_(editable|contents)/i)) { var f, h, l = new CKEDITOR.dom.element("div"); for (l.setHtml(b); 1 == l.getChildCount() && (f = l.getFirst()) && f.type == CKEDITOR.NODE_ELEMENT && (f.hasClass("cke_editable") || f.hasClass("cke_contents"));) l = h = f;
            ...
            getRangeAtDropPosition: function(b, a) {
                ...
                if (document.caretRangeFromPoint) c = a.document.$.caretRangeFromPoint(d,
                    ...
                    if (document.body.createTextRange) {
                        ...
                        try {
                            for (var h = !1, l = 0; 20 > l && !h; l++) { if (!h) try { c.moveToPoint(d, e - l), h = !0 } catch (p) {}
                            ...
                            if (h) {
                                ...
                                t.remove()
                            } else { var u = a.document.$.elementFromPoint(d, e),
                                    n = new CKEDITOR.dom.element(u),
                                    r; if (n.equals(a.editable()) || "html" == n.getName()) return g && g.startContainer && !g.startContainer.equals(a.editable()) ? g : null;
                                r = n.getClientRect();
        ...
        CKEDITOR.plugins.clipboard.dataTransfer.prototype = {
            getData: function(b) { b = this._.normalizeType(b); var a = this._.data[b]; if (void 0 === a || null === a || "" === a) try { a = this.$.getData(b) } catch (c) {}
                if (void 0 === a || null === a || "" === a) a = ""; "text/html" == b ? (a = a.replace(this._.metaRegExp, ""), (b = this._.bodyRegExp.exec(a)) && b.length && (a = b[1], a = a.replace(this._.fragmentRegExp, ""))) : "Text" == b && CKEDITOR.env.gecko && this.getFilesCount() && "file://" == a.substring(0, 7) && (a = ""); return a },
            setData: function(b,
            ...
            init: function(a) {
                if (!a.blockless) {
                    ...
                    a.addCommand("removediv", { requiredContent: "div", exec: function(a) {
                            function c(b) {
                                (b = CKEDITOR.plugins.div.getSurroundDiv(a, b)) && !b.data("cke-div-added") && (f.push(b), b.data("cke-div-added")) } for (var b = a.getSelection(), g = b && b.getRanges(), e, h = b.createBookmarks(), f = [], d = 0; d < g.length; d++) e = g[d], e.collapsed ? c(b.getStartElement()) : (e = new CKEDITOR.dom.walker(e), e.evaluator = c, e.lastForward()); for (d = 0; d < f.length; d++) f[d].remove(!0);
                            b.selectBookmarks(h) } });
    ...
    (function() {
        function l(a, b, c, f, p, l, t, v) {
            var w = a.config,
                ...
                k = p.split(";");
            p = [];
            for (var m = {}, d = 0; d < k.length; d++) { var h = k[d]; if (h) { var h = h.split("/"),
                        u = {},
                        n = k[d] = h[0];
                    u[c] = p[d] = h[1] || n;
            ...
            a.ui.addRichCombo(b, {
                ...
                init: function() { this.startGroup(f.panelTitle); for (var a = 0; a < k.length; a++) { var b = k[a];
        ...
        function r(a, b, c) { var f = b.pop(); if (f) { if (c) return r(a, b, f.equals(c) ? null : c);
                c = f.clone();
                a.insertNode(c);
    ...
    (function() {
        ...
        CKEDITOR.unlinkCommand.prototype = {
            exec: function(c) { var b = new CKEDITOR.style({ element: "a", type: CKEDITOR.STYLE_INLINE, alwaysRemoveElement: 1 });
                c.removeStyle(b) },
